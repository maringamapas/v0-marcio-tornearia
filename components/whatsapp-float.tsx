...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-[100] flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#25d366] to-[#128c7e] text-white shadow-2xl transition-all duration-300 hover:scale-110 hover:rotate-12 animate-pulse-slow hover:animate-none focus-visible:ring-4 focus-visible:ring-green-300 focus-visible:ring-offset-2"
